...
@section('breadcrumb')
    ...
    <li><a href="/targetkadis">Target Kadis</a></li>
    <li>Ubah Data</li>
@endsection
@section('content')
...
<form class="form-horizontal validate-form" role="form" 
    method="post" action="/targetkadis/update/{{$data->id}}">
{{ csrf_field() }}
<div class="col-sm-12">
    <div class="widget-box">
        <div class="widget-header">
            <h4 class="widget-title"> Target Kepala Dinas Periode {{$data->yearfrom}} - {{$data->yearto}}</h4>
        </div>
    </div>
    @foreach ($renstra as $item)
    <div class="widget-box">
        <div class="widget-header">
            <h4 class="widget-title"> Ubah Target Kadis  Tahun {{$item->years}}</h4>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="targetkadis_id[]" value="{{$data->id}}">
                                {{$row->names}}
                            </td>
                            <td>
                                @php
                                    $isi = $injectQuery->getRenstra3($data->id,$item->years,$row->id);
                                @endphp
