                ...
                <div class="widget-main no-padding">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" 
                            ...
                            <div class="col-sm-9">
                                @if ($valid->validasi_kadis=='Y')
                                    <input type="radio" required value="N" 
                                    name="validasi_kadis"/> &nbsp; Belum di Verifikasi &nbsp;
                                    <input type="radio" required value="Y" checked
                                    name="validasi_kadis"/> &nbsp; Terverifikasi &nbsp;
                                    <input type="radio" required value="R"
                                    name="validasi_kadis"/> &nbsp; Perlu di perbaiki &nbsp; 
                                @elseif ($valid->validasi_kadis=='R')
                                    <input type="radio" required value="N" 
                                    name="validasi_kadis"/> &nbsp; Belum di Verifikasi &nbsp;
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" 
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="hidden" name="kadis_id" value="{{auth()->user()->id}}">
                                <input type="hidden" id="dates" value="{{date('Y-m-d')}}" name="kadis_dates"/>
                                <input type="text" class="col-xs-10 col-sm-10 required "  value="{{$valid->catatan_kadis}}"
                                name="catatan_kadis" required/>
                            </div>
                    </div>
