...
@section('breadcrumb')
    ...
    <li><a href="/targetbid">Target Bidang</a></li>
...
method="post" action="/targetbid/updatemeta/{{$data->id}}">
{{ csrf_field() }}
<div class="row">
<div class="col-md-12">
<div class="col-md-12">
   <div class="panel panel-info">
       <div class="panel-heading"><h3 class="panel-title">Ubah Meta Data Target Bidang </h3></div>
...
<div class="panel-footer">
    <div class="form-actions right">
        ...
        <a href="/targetbid/edit/{{$data->id}}" class="btn btn-sm">
