...
<head>
    ...
    <title>Laporan Realisasi Bidang {{$bid->name}} Periode {{$blnindo}} {{$request->years}}</title>
    <?php
        header("Content-type: application/vnd-ms-excel");
        header("Content-Disposition: attachment; filename=Laporan-Realisasi-Bidang-$bid->name-Periode-$blnindo-$request->years.xls");
    ?>
    <style>
        @page {
                size: landscape;
...
<body>
    <div class="col-sm-12 isi" style="text-align: center">
        <div style="align:center; font-size: 18px; text-transform: uppercase;"><b>
                LAPORAN PENGUKURAN KINERJA BULAN {{strtoupper($blnindo)}}<br>
                BIDANG {{strtoupper($bid->name)}}<br>
    ...
    <div>
        <table class="atas">
            ...
            <tr class="atas">
                ...
                <td class="atas"></td>
                <td class="atas"></td>
                <td class="atas" style="text-transform: uppercase;">KEPALA BIDANG {{strtoupper($bid->name)}}</td>
            </tr>
            <tr class="atas">
                <td class="atas"></td>
